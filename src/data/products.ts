...
export const products: Product[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Clone the repo and run it on 127.0.0.1:8090. An optional private self-host for the owner can keep that same loopback port. This is not a hosted multi-tenant SaaS, and there is no public Contabo demo. The github.io page is a static gallery only. A studio hostname (os.agentic-systems-studio.com) is planned only — it is not live, not attached, and is not a product URL.',
    ],
    features: [
      'Hermes and OpenClaw seats on one machine',
      'Skills, on-disk memory, and a local scheduler',
      'Optional shell and exec, gated off by default',
